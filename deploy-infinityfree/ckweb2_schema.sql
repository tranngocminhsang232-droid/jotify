...
--
-- Host: localhost    Database: ckweb2
-- ------------------------------------------------------
...
--
-- Table structure for table `label_note`
--
...
CREATE TABLE `label_note` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `label_note_label_id_note_id_unique` (`label_id`,`note_id`),
  KEY `label_note_note_id_foreign` (`note_id`),
  CONSTRAINT `label_note_label_id_foreign` FOREIGN KEY (`label_id`) REFERENCES `labels` (`id`) ON DELETE CASCADE,
  CONSTRAINT `label_note_note_id_foreign` FOREIGN KEY (`note_id`) REFERENCES `notes` (`id`) ON DELETE CASCADE
...
CREATE TABLE `labels` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `labels_user_id_name_unique` (`user_id`,`name`),
...
CREATE TABLE `note_images` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `note_images_note_id_foreign` (`note_id`),
  CONSTRAINT `note_images_note_id_foreign` FOREIGN KEY (`note_id`) REFERENCES `notes` (`id`) ON DELETE CASCADE
...
CREATE TABLE `user_preferences` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `font_size` enum('small','medium','large','x-large') NOT NULL DEFAULT 'medium',
  `note_color` varchar(7) NOT NULL DEFAULT '#ffffff',
...
-- Dump completed on 2026-04-20 16:03:03
