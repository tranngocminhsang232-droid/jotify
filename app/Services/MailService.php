...
class MailService
{
     ...
     * @return bool
     */
    public static function sendNoteSharedEmail(string $toEmail, string $toName, $note, string $shareUrl): bool
    {
        try {
            $mail = self::createMailer();
            $mail->addAddress($toEmail, $toName);
            $mail->Subject = 'A note has been shared with you via ' . config('app.name');
            $mail->isHTML(true);
            ...
            $mail->AltBody = "A note has been shared with you. View it at:\n{$shareUrl}";
